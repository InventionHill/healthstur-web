                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center relative z-10">
                    ...
                    >
                        ...
                        <p className="text-gray-300 text-sm md:text-base leading-relaxed max-w-3xl mx-auto">
                            {description || "At HEALTHSTUR, we aim to provide high-quality fitness and diet programs with clear and fair service terms. This Refund Policy explains how refunds are handled for our plans, coaching services, and digital programs when you purchase through our website or platform."}
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    {loading ? (
                        ...
                        >
                            {content ? (
                                ...
                                <p className="text-center text-gray-500">Refund policy applies to all services. (Default policy content)</p>
                            )}
                        </motion.div>
                    )}
                </div>
