                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center relative z-10">
                    ...
                    >
                        ...
                        <p className="text-gray-300 text-sm md:text-base leading-relaxed max-w-3xl mx-auto">
                            {description || "At HEALTHSTUR we value your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your data when you use our website and fitness & diet services."}
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    {loading ? (
                        ...
                        >
                            {content ? (
                                ...
                                <p className="text-center text-gray-500">Privacy policy applies to all services. (Default policy content)</p>
                            )}
                        </motion.div>
                    )}
                </div>
