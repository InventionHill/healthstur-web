                ...
                >
                    ...
                    <div className="mb-10">
                        <span className="text-xs font-bold tracking-[0.2em] uppercase opacity-90">
                            HOME &gt; PROGRAMS &gt; AGE GROUP SPECIFIC
                        </span>
                    </div>
                    ...
                    <p className="max-w-3xl mx-auto text-gray-200 text-base md:text-lg leading-relaxed font-light">
                        Every age has different nutritional needs, hormonal patterns, and fitness requirements. Healthstur designs programs that align with the body’s natural growth, metabolism, and lifestyle demands at every stage of life.
                    </p>
                </motion.div>
            </div>
        </section>
