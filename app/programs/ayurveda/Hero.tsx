            ...
            <div className="relative z-10 container mx-auto px-4 text-center text-white">
                ...
                >
                    ...
                    <p className="max-w-3xl mx-auto text-gray-200 text-base md:text-lg leading-relaxed font-light">
                        Ayurveda focuses on balancing the body, mind, and energy through natural practices. Healthstur integrates Ayurvedic wisdom with modern nutrition and lifestyle science to create sustainable, holistic wellness solutions.
                    </p>
                </motion.div>
            </div>
        </section>
