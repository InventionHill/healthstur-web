            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center text-white">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-10 tracking-tight">
                        Fitness & Diet Help Center Guidance at
                        Every Step
                    </h1>

                    {/* Description */}
                    <p className="max-w-3xl mx-auto text-gray-200 text-base md:text-lg leading-relaxed font-light">
                        Find quick answers, expert guidance, and step-by-step support for your workout and diet plans. Get the help you need to stay on track and achieve your fitness goals with confidence.
                    </p>
                </motion.div>
            </div>
        </section>
